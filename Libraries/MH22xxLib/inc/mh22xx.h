...
/**
 * @brief mh22xx Standard Peripheral Library version number
   */
#define __mh22xx_STDPERIPH_VERSION_MAIN   (0x03) /*!< [31:24] main version */                                  
#define __mh22xx_STDPERIPH_VERSION_SUB1   (0x05) /*!< [23:16] sub1 version */
#define __mh22xx_STDPERIPH_VERSION_SUB2   (0x00) /*!< [15:8]  sub2 version */
#define __mh22xx_STDPERIPH_VERSION_RC     (0x00) /*!< [7:0]  release candidate */ 
#define __mh22xx_STDPERIPH_VERSION       ( (__mh22xx_STDPERIPH_VERSION_MAIN << 24)\
                                             |(__mh22xx_STDPERIPH_VERSION_SUB1 << 16)\
                                             |(__mh22xx_STDPERIPH_VERSION_SUB2 << 8)\
                                             |(__mh22xx_STDPERIPH_VERSION_RC))
...
#define __NVIC_PRIO_BITS          4 /*!< mh uses 4 Bits for the Priority Levels    */
#define __Vendor_SysTickConfig    0 /*!< Set to 1 if different SysTick Config is used */

/**
 * @brief mh22xx Interrupt Number Definition, according to the selected device 
...
/******  mh specific Interrupt Numbers *********************************************************/
  ...
  QUADSPI_IRQn				  = 60,		/*!< QUADSPI Interrupt        							  */
  SYMC_IRQn        			  		= 68,
  TRNG_IRQn        			  		= 69,     
  SENSOR_IRQn        		  		= 70   
...
/*!< mh22xx Standard Peripheral Library old types (maintained for legacy purpose) */
typedef int32_t  s32;
typedef int16_t s16;
typedef int8_t  s8;
...
/*!< mh22xx Standard Peripheral Library old definitions (maintained for legacy purpose) */
...
typedef struct
{
  ...
  __IO uint16_t TRISE;
  uint16_t  RESERVED8;
  uint32_t  RESERVED9[(0xF0-0x24)/4];
  __IO uint32_t PEC_CTRL;
  __IO uint32_t CR3;
  uint32_t  RESERVED10;
  __IO uint32_t FILITER;
} I2C_TypeDef;
...
typedef struct
{
  ...
  __IO uint16_t I2SPR;
  uint16_t  RESERVED8;  
  uint32_t  RESERVED9[(0x40-0x24)/4];
  uint32_t  CR3;
  uint32_t  SR2;
  uint32_t  SPI_FIFO_CLR; 
  uint32_t  I2S_EXT;    
  uint32_t  SPI_EXT;      
} SPI_TypeDef;
...
typedef struct
{
	...
	__IO uint32_t SYSCFG_RSVD0[(0xCC-0x04) >> 2];
	__IO uint32_t SSC_CLK_EN;
	__IO uint32_t SYSCFG_RSVD1[(0xF0-0xD0) >> 2];
	__IO uint32_t SYSCFG_CR1;
	__IO uint32_t SYSCFG_CR2;
	__IO uint32_t SYSCFG_CR3;
	__IO uint32_t SYSCFG_CR4;
}SYSCFG_TypeDef;
...
typedef struct
{
  ...
  __IO uint32_t CR1;      /*!< QUADSPI  Data Configuration,                    Address offset: 0x60 */
  __IO uint32_t RSVD2[2];
  __IO uint32_t WR_CCR;   /*!< QUADSPI Memory Remap Write Configuration,           Address offset: 0x6C */
  __IO uint32_t DLY0;     /*!< QUADSPI Memory Remap Write Configuration,           Address offset: 0x70 */
  __IO uint32_t DLY1;     /*!< QUADSPI Memory Remap Write Configuration,           Address offset: 0x74 */
  __IO uint32_t DLY2;     /*!< QUADSPI Memory Remap Write Configuration,           Address offset: 0x78 */
  __IO uint32_t DLY3;     /*!< QUADSPI Memory Remap Write Configuration,           Address offset: 0x7C */
} QUADSPI_TypeDef;

/** 
  * @brief DSP(Digital Signal Process) 
  */
typedef struct
{
	__IO uint32_t DIV_A;   
	...
	__IO uint32_t DIV_C;
	__IO uint32_t DIV_D;
	__IO uint32_t SQRT_A;  
	__IO uint32_t RESERVED1[2]; 
	__IO uint32_t SQRT_D;  
	__IO uint32_t ALU_C;      // ³ý·¨¿ØÖÆÆ÷  
	__IO uint32_t CR;     // DSP¿ØÖÆÆ÷      
	__IO uint32_t CR2;    // DSP¿ØÖÆÆ÷2      	
	__IO uint32_t RESERVED2[(0x40-0x2C)/4];  
	__IO float F_ADD_A; // 40
	__IO float F_ADD_B;
	...
	__IO uint32_t F_CMP_D;  
	__IO float F_F2I_A;  
	__IO uint32_t RESERVED9[2];
	__IO int32_t F_F2I_D;  
	__IO int32_t F_I2F_A;  
	__IO uint32_t RESERVED10[2]; 
	__IO float F_I2F_D;  
	__IO uint32_t RESERVED11[(0xF0-0xC0)/4]; 
	__IO uint32_t F_SR;
	__IO uint32_t RESERVED12[(0x100-0xF4)/4]; 
	__IO uint32_t R0;
	__IO uint32_t R1;
	__IO uint32_t R2;
	__IO uint32_t R3;
	...
	__IO uint32_t R7;	
	__IO uint32_t PC;	
	__IO uint32_t RESERVED13[(0x130-0x124)/4]; 	
	__IO uint32_t FUNC1_0;	
	__IO uint32_t FUNC1_1;
}DSP_TypeDef;
/*****************************************************/
/**
  * @}
...
#define QSPI_R_BASE           ((uint32_t)0xB0000000) /*!< QuadSPI registers base address */
#define DSP_BASE              ((uint32_t)0x50061000) /*!< DSP registers base address */
/**
  * @}
  */
...
/******************  Bit definition for QUADSPI_CR1 register  *****************/	//by YS 2023.3.9
#define QUADSPI_CR1_R_FLEVEL                      ((uint32_t)0x00007F00)
#define QUADSPI_CR1_CRYPT_EN                      ((uint32_t)0x02000000)
#define QUADSPI_CR1_REMAP_WR_EN                   ((uint32_t)0x10000000)
...
/****************  Bit definition for DSP_CR register  *****************/
#define  DSP_CR_ADDR      			         ((uint32_t)0x0000FFFF)                 /*!< DSP start address bytes */
#define  DSP_CR_START      			         ((uint32_t)0x00010000)                 /*!< Start DSP */
#define  DSP_CR_STOP       			         ((uint32_t)0x00020000)                 /*!< Stop DSP */
#define  DSP_CR_DONE_IE   			         ((uint32_t)0x00040000)                 /*!< Enable done interruput */
#define  DSP_CR_EVENT_IE   			         ((uint32_t)0x00080000)                 /*!< Enable event interruput */
#define  DSP_CR_ERR_IE   			         ((uint32_t)0x00100000)                 /*!< Enable error interruput */
#define  DSP_CR_DMA      			         ((uint32_t)0x00200000)                 /*!< Enable DSP DMA */
#define  DSP_CR_RESUME     			         ((uint32_t)0x00400000)                 /*!< Resume DSP after DSP suspended */
#define  DSP_CR_DMA_AUTO_RESUME              ((uint32_t)0x00800000)                 /*!< Enable DSP auto resume mode */
#define  DSP_CR_DEBUG_EN       		         ((uint32_t)0x01000000)                 /*!< Enable DSP debug mode */
#define  DSP_CR_DEBUG_STEP   		         ((uint32_t)0x02000000)                 /*!< step one line */
#define  DSP_CR_SUSPEND_STAT   		         ((uint32_t)0x08000000)                 /*!< DSP suspend status */
#define  DSP_CR_ERR_STAT   		             ((uint32_t)0x10000000)                 /*!< DSP error status */
#define  DSP_CR_EVENT_STAT   		         ((uint32_t)0x20000000)                 /*!< DSP event status */
#define  DSP_CR_DONE_STAT   		         ((uint32_t)0x40000000)                 /*!< DSP done status */
#define  DSP_CR_RUN   		                 ((uint32_t)0x80000000)                 /*!< DSP run status */


/****************  Bit definition for DSP_CR2 register  *****************/
#define DSP_CR2_S_ADDR_32K   			     ((uint32_t)0x80000000)                 /*!< Select DSP address mode betwen 32KB or 1KB */
#define DSP_CR2_F_RND   			         ((uint32_t)0x00000007)          //     /*!< Select DSP rounding mode of float calculation */
