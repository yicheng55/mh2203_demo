...
static const struct httpd_fsdata_file file__at_STM32F2x7_files_logo_jpg[] = { {
 NULL, //NULL, 
 "/STM32F2x7_files/logo.jpg",
 data__at_STM32F2x7_files_logo_jpg,
 sizeof(data__at_STM32F2x7_files_logo_jpg)
}};
//[Joseph add].[Add 404 if pages not find]
static const struct httpd_fsdata_file file__404_html[] = {{
 file__at_STM32F2x7_files_logo_jpg, //NULL, //NULL, 
 "/404.html",
#if 1
 data_at_404_html,
 sizeof(data_at_404_html)
#endif
}};
...
//------------------------------
//[Joseph add].
static const struct /*fsdata_file*/ /*file__image_AR_S_gif[] = {{
file__404_html,
"/images/AR_S.gif",
data_images_ar_s_gif,
sizeof(data_images_ar_s_gif)
}};*/
//------------------------------
#endif
//[Joseph add].
static const struct httpd_fsdata_file file__image_AR_S_gif[] = {{
 file__404_html,
 "/images/AR_S.gif",
 data_images_ar_s_gif,
 sizeof(data_images_ar_s_gif)
...
static const struct httpd_fsdata_file file_images_AT_gif[] = {{
 file__image_AR_S_gif, //file__404_html, //NULL, 
 "/images/AT.gif",
 data_images_AT_gif, 
 sizeof(data_images_AT_gif)
}};

static const struct httpd_fsdata_file file_images_at32_newline__gif[] = {{
 file_images_AT_gif, 
 "/images/at32_newline_.gif",
 data_images_at32_newline__gif, 
 sizeof(data_images_at32_newline__gif)
}};
static struct httpd_fsdata_file file_AT32F407ADC_html[] = {{
 /*file_AT32F407_html*/ file_images_at32_newline__gif, 
 "/AT32F407ADC.html",
...
static 
const struct /*fsdata_file*/ httpd_fsdata_file file_AT32F407_html[] = {{/*file_images_at32_newline__gif*/ file_AT32F407ADC_html, "/AT32F407.html", data_AT32F407_html, sizeof(data_AT32F407_html)}};

//const struct httpd_fsdata_file file_webMain_shtml[] = {{NULL, data_webMain_shtml, data_webMain_shtml + 15, 
//sizeof(data_webMain_shtml) - 15}};
static 
const struct /*fsdata_file*/ httpd_fsdata_file file_AT32F407LED_html[] = {{/*file_AT32F407ADC_html*/ file_AT32F407_html, "/AT32F407LED.html", data_AT32F407LED_html, 
...
#define HTTPD_FS_NUMFILES 12 //8 is now
