...
#include "stdint.h"
#include "uip.h"
#include "trans_level.h" /* 提供 AT_TMPSTR_LEN 等 (原透過 AT32 的 includes.h 轉引入) */
//#include "at_opts.h"

//#define CUS_TEST // For customer test mode

#define IPSPP_VERSION "AT32F413 IPSPP1001_V1.0.5R9 Release 20250808"
//#define IPSPP_VERSION "AT32F413 IPSPP1001_V1.0.5R8 Release 20240702"
//#define IPSPP_VERSION "AT32F413 IPSPP1001_V1.0.5R7 Release 20240702"
//#define IPSPP_VERSION "AT32F413 IPSPP1001_V1.0.5R2 Release 20171109" //current module source code version
...
//extern uint8_t trans_connected;
...
extern char at_tmpstr[AT_TMPSTR_LEN];
//extern char show_role[AT_ROLESTR_LEN];
...
void eth_rcv_atcmd_process(uint8_t n, char *tmp[]); //uint8_t eth_rcv_atcmd_process(char *buf);

/* AT Base Command function */
