...
#define TIM_INPUT_STATE		TIM_IT_CC1
...
void TPAD_Reset(void)
{
	...
	TIM_ClearITPendingBit(TIM3, TIM_INPUT_STATE|TIM_IT_Update); //清除中断标志
...
{				   
	TPAD_Reset();
	while(TIM_GetFlagStatus(TIM3, TIM_INPUT_STATE) == RESET)//等待捕获上升沿
	{
