...
void Set_USBClock(void)
{
  ...
  /* Select USBCLK source */
	...
	else if(clocks.SYSCLK_Frequency == 120000000)
		RCC_USBCLKConfig(RCC_USBCLKSource_PLLCLK_2Div5);
	else if(clocks.SYSCLK_Frequency == 144000000)
		RCC_USBCLKConfig(RCC_USBCLKSource_PLLCLK_Div3);
	else if(clocks.SYSCLK_Frequency == 168000000)
		RCC_USBCLKConfig(RCC_USBCLKSource_PLLCLK_3Div5);
	else if(clocks.SYSCLK_Frequency == 192000000)
		RCC_USBCLKConfig(RCC_USBCLKSource_PLLCLK_Div4);
	else if(clocks.SYSCLK_Frequency == 216000000)
