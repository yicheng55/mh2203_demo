...
uint8_t u8RngBuff[0x60] = {0};		//脣忙禄煤脢媒脛脷虏驴脢鹿脫脙驴脮录盲拢卢脪陋脟贸脠芦戮脰脟脪虏禄脪陋脨脼赂脛脛脷虏驴脢媒戮脻
...
{   
	...
	*(uint32_t *)(0x40016CCC) = 0x07;
	...
	DBG_PRINT("\n");
	DBG_PRINT("****SYSCLK: %3.1fMhz, HCLK: %3.1fMhz, PCLK1: %3.1fMhz, PCLK2: %3.1fMhz*****\n", (float)clocks.SYSCLK_Frequency/1000000, (float)clocks.HCLK_Frequency/1000000, \
	(float)clocks.PCLK1_Frequency/1000000, (float)clocks.PCLK2_Frequency / 1000000);
	DBG_PRINT("***********************************Crypt Test!***********************************\n");
	DBG_PRINT("\n");
	
	MHRAND_Init((uint32_t*)&u8RngBuff, sizeof(u8RngBuff));
