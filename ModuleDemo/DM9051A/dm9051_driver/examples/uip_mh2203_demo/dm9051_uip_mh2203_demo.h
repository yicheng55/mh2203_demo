#ifndef DM9051_UIP_MH2203_DEMO_H
#define DM9051_UIP_MH2203_DEMO_H
...
/* uIP 整合用的開啟流程 (HAL bind + core_open)，比照 mh2030a demo。
 * 開啟後以 dm9051_uip_mh2203_demo_eth() 取得 netif 私有資料供 stack 使用。 */
...
#endif /* DM9051_UIP_MH2203_DEMO_H */
